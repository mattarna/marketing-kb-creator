...
| **F3 · Le skill dei nodi** | Dopo ricognizione: la maggior parte RIUSA producer esistenti (launcher/marketing). Restano da scrivere solo i gap veri: `kb-message-house`, `kb-channels`, `kb-lifecycle`, `kb-numbers-baseline` | D-3 | [x] 4 skill-gap scritte + 4 nodi "riusa" ricablati sui producer |
